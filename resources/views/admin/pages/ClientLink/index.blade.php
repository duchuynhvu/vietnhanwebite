...
@section('page')
    <div class="page">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ __('admin.clientlink') }}</li>
            </ol>
            <div class="page-header-actions">
                <a class="btn btn-sm btn-default btn-outline btn-round" href="{{ url('/links/create') }}">
                                    ...
                                    <table class="table table-bordered" data-plugin="selectable"
                                        ...
                                        @foreach ($links as $key => $item)
                                            <tr>
                                                ...
                                                <td><a href="{{ asset('/uploads/links') }}/{{ $item->logo }}"
                                                       class="inline-block" data-plugin="magnificPopup"><img
                                                                class="preview"
                                                                src="{{ asset('/uploads/links') }}/{{ $item->logo }}"></a>
                                                </td>
                                                <td>{{ $item->name }}</td>
                                                <td>{{ $item->created_at }}</td>
                                                <td>{{ $item->updated_at }}</td>
                                                <td><a class="btn btn-default"
                                                       href="{{ url('/links') }}/{{ $item->id }}/edit">{{ __('admin.edit') }}</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
    ...
    <input type="hidden" id="database" name="_token" value="/links">
@endsection