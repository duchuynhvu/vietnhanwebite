...
@section('page')
    <div class="page">
        <div class="page-header">
            ...
            <div class="page-header-actions">
                <a class="btn btn-sm btn-default btn-outline btn-round" href="{{ url('/news-categories/create') }}">
                                    ...
                                    <table class="table table-bordered" data-plugin="selectable" data-row-selectable="true">
                                        ...
                                        @foreach ($categories as $key => $item)
                                            <tr>
                                                ...
                                                <td><a class="btn btn-default" href="{{ url('/news-categories') }}/{{ $item->id }}/edit">{{ __('admin.edit') }}</a></td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
    ...
    <input type="hidden" id="database" name="_token" value="/news-categories">
@endsection