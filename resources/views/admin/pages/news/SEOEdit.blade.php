    ...
    <div class="page">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('/admin/news-seo') }}">SEO</a></li>
                <li class="breadcrumb-item active">{{ __('admin.edit') }}</li>
            </ol>
            <div class="page-header-actions">
                <a class="btn btn-sm btn-default btn-outline btn-round" href="{{ url('/admin/news-seo') }}">
                ...
                <div class="panel-body container-fluid">
                    <div class="row row-lg">
                        <div class="col-md-12">
                            ...
                            @endif
                            <form method="post" action="{{ url('/admin/news-seo') }}/{{ $news->id }}">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
