...
@section('page')
    <div class="page">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ __('admin.service') }}</li>
            </ol>
            <div class="page-header-actions">
                <a class="btn btn-sm btn-default btn-outline btn-round" href="{{ url('/services/create') }}">
                                    ...
                                    <table class="table table-bordered" data-plugin="selectable" data-row-selectable="true">
                                        ...
                                        @foreach ($services as $key => $item)
                                            <tr>
                                                ...
                                                <td><a class="btn btn-default" href="{{ url('/services') }}/{{ $item->id }}/edit">{{ __('admin.edit') }}</a></td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
    ...
    <input type="hidden" id="database" name="_token" value="/services">
@endsection