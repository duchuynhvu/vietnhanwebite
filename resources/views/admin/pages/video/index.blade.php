...
@section('page')
    <div class="page">
        <div class="page-header">
            ...
            <div class="page-header-actions">
                <a class="btn btn-sm btn-default btn-outline btn-round" href="{{ url('/videos/create') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-default"
                                                       href="{{ url('/videos') }}/{{ $item->id }}/edit">{{ __('admin.edit') }}</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
    ...
    <input type="hidden" id="database" name="_token" value="/videos">
@endsection