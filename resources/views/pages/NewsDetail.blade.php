    ...
    <section id="content" class="content">
        <div class="container">
            <nav class="breadcrumb">
                ...
                <a class="breadcrumb-item" href="{{ url('/news') }}" style="color: #f28e20">{{ __('interface.news') }}</a>
                <span class="breadcrumb-item active">{{ __('interface.detail') }}</span>
            </nav>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 wow slideInLeft">
                        <div class="wapp-text">
                            <h1>{{ $news->showTitle() }}</h1>
                            <div class="post-info">
                                <p class="post-by">by <a href="#" title="">{{ $news->user->name }}</a>
                                    | {{ date('F dS, Y', strtotime($news->created_at)) }}</p>
                                <div class="desc" style="margin-bottom: 20px; font-weight: bold; height: auto">
                                    <p>{{ $news->showDescription() }}</p>
                                </div>
                            </div>
                            <p>{!! $news->showContent() !!}</p>
                        </div>
                    </div>
                </div>
            </div>
